...
impl Digest for Sha1 {
    ...
    fn digest(&mut self) -> Vec<u8> {
        ...
        self.buffer.extend(std::iter::repeat(0).take(padding_needed as usize));
        ...
        self.buffer.clone().chunks_exact(Sha1::CHUNK_SIZE).for_each(|c| self.compress(c));
