...
mod tests {
    ...
    fn challenge_1() -> Result<()> {
        ...
        assert_eq!("SSdtIGtpbGxpbmcgeW91ciBicmFpbiBsaWtlIGEgcG9pc29ub3VzIG11c2hyb29t", base64::encode(&hex::decode(hex)?));
    ...
    fn challenge_3() -> Result<()> {
        ...
        assert_eq!("436f6f6b696e67204d432773206c696b65206120706f756e64206f66206261636f6e", hex_encode(&best_guess));
        Ok(())
    }
    ...
    fn challenge_4() -> Result<()> {
        ...
        assert_eq!("4e6f77207468617420746865207061727479206973206a756d70696e670a", hex_encode(&best_guess));
